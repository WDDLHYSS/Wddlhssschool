...
import com.wddlhyss.eduservice.entity.subject.TwoSubject;
import com.wddlhyss.eduservice.listener.SubjectExcelListener;
import com.wddlhyss.eduservice.mapper.EduSubjectMapper;
...
public class EduSubjectServiceImpl extends ServiceImpl<EduSubjectMapper, EduSubject> implements EduSubjectService {
    ...
    public List<OneSubject> getAllOneTwoSubject() {
        ...
        //创建list集合，用于存储最终封装数据
        List<OneSubject> finalSubjectList = new ArrayList<>();//3 封装一级分类
