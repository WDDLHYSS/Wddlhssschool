...
import com.wddlhyss.eduorder.entity.PayLog;
import com.wddlhyss.eduorder.mapper.PayLogMapper;
import com.wddlhyss.eduorder.service.OrderService;
import com.wddlhyss.eduorder.service.PayLogService;
...
public class PayLogServiceImpl extends ServiceImpl<PayLogMapper, PayLog> implements PayLogService {
    ...
    public Map createNatvie(String orderNo) {
        try {
            ...
            HttpUtils client = new HttpUtils("https://api.mch.weixin.qq.com/pay/unifiedorder");
            //设置xml格式的参数
            ...
            throw new WddlhyssException(20001, "生成二维码失败");
        }
    }
    ...
    public Map<String, String> queryPayStatus(String orderNo) {
        try {
            ...
            //2 发送httpclient
            HttpUtils client = new HttpUtils("https://api.mch.weixin.qq.com/pay/orderquery");
            client.setXmlParam(WXPayUtil.generateSignedXml(m, "T6m9iK73b0kn9g5v426MKfHQH7X8rKwb"));
            client.setHttps(true);
            client.post();
